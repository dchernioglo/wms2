...
public class CreateNewAccount extends javax.swing.JFrame {
	...
	inAddress[0] = jTextField7.getText(); //address
	inAddress[1] = jTextField8.getText(); //city
	inAddress[2] = jTextField9.getText(); //state
	inAddress[3] = jTextField10.getText(); //zip code
